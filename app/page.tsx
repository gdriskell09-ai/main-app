...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[#f7f5ef] text-slate-950">
      <section className="border-b border-black/5 bg-[#f7f5ef]">
      ...
      <section className="relative overflow-hidden bg-[#f7f5ef]">
        <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-emerald-100/60 to-transparent" />
        <div className="absolute right-0 top-10 h-72 w-72 rounded-full bg-amber-200/30 blur-3xl" />
        <div className="absolute left-0 top-24 h-72 w-72 rounded-full bg-sky-200/30 blur-3xl" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            <div className="inline-flex rounded-full border border-emerald-200 bg-white/80 px-4 py-2 text-sm font-medium text-emerald-800 shadow-sm">
              Light-premium websites, systems, and growth tools for field-service businesses
            </div>
          ...
          <div className="flex items-center">
            <div className="w-full rounded-[2rem] border border-black/5 bg-white p-4 shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <div className="rounded-[1.5rem] bg-gradient-to-br from-emerald-900 via-slate-900 to-slate-800 p-6 text-white">
                ...
                <div className="mt-6 grid gap-4">
                  ...
                  <div className="rounded-2xl bg-amber-200/15 p-4 ring-1 ring-inset ring-amber-100/20">
      ...
      <section id="trades" className="border-t border-black/5 bg-[#fcfaf5]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {trades.map((trade) => (
              <div
                key={trade}
                className="rounded-3xl border border-black/5 bg-white p-5 text-sm font-semibold text-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
              >
                {trade}
              </div>
            ))}
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {outcomes.map((item, index) => (
              <div
                ...
                className={
                  index === 0
                    ? "rounded-[2rem] border border-emerald-200 bg-emerald-50 p-7 shadow-sm"
                    : "rounded-[2rem] border border-black/5 bg-white p-7 shadow-sm"
                }
              >
      ...
      <section id="examples" className="border-y border-black/5 bg-[#fcfaf5]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="max-w-2xl">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {examples.map((example, index) => (
              <div
                ...
                className={
                  index === 1
                    ? "rounded-[2rem] border border-amber-200 bg-gradient-to-br from-white to-amber-50 p-7 shadow-[0_24px_60px_rgba(146,64,14,0.08)]"
                    : "rounded-[2rem] border border-black/5 bg-white p-7 shadow-sm"
                }
              >
                <div className="mb-5 h-40 rounded-[1.5rem] border border-black/5 bg-gradient-to-br from-slate-100 via-white to-emerald-50 p-4">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-black/5 bg-slate-950 p-8 text-white shadow-sm">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-amber-200">Next</p>
      ...
      <section id="roadmap" className="border-y border-black/5 bg-[#fcfaf5]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="max-w-2xl">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {roadmap.map((item) => (
              <div
                key={item}
                className="rounded-3xl border border-black/5 bg-white p-5 text-sm font-medium text-slate-800 shadow-sm"
              >
                {item}
              </div>
            ))}
      ...
      <section className="bg-[#f7f5ef]">
        <div className="mx-auto max-w-5xl px-6 py-20 lg:px-8">
          <div className="rounded-[2rem] border border-black/5 bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900 p-10 text-white shadow-[0_30px_80px_rgba(15,23,42,0.16)] lg:p-12">
